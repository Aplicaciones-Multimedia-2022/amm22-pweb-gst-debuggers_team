		   ...
		   // extrae el valor numerico
				...
				escalado_canvas = tamaño_canvas[1]/tamaño_canvas[0]
					...
					if(button == 5 && intro == false){
						...
						ctx.drawImage(astronauta.sprite[astronauta.recorrerSprite],astronauta.coordx,astronauta.coordy,(astronauta.sprite[astronauta.recorrerSprite].width/astronauta.escalaastro)*escalado_canvas, (astronauta.sprite[astronauta.recorrerSprite].height/astronauta.escalaastro)*escalado_canvas)
						for(let i = 0;i<meteoritos.length;i++){
							ctx.drawImage(meteoritos[i].sprite[meteoritos[i].recorrerSprite],meteoritos[i].coordx,meteoritos[i].coordy,(meteoritos[i].sprite[meteoritos[i].recorrerSprite].width/meteoritos[i].escalameteor)*escalado_canvas, (meteoritos[i].sprite[meteoritos[i].recorrerSprite].height/meteoritos[i].escalameteor)*escalado_canvas)
						}
						for(let i = 0;i<ovnis.length;i++){
							ctx.drawImage(ovnis[i].sprite[ovnis[i].recorrerSprite],ovnis[i].coordx,ovnis[i].coordy,(ovnis[i].sprite[ovnis[i].recorrerSprite].width/ovnis[i].escalaovni)*escalado_canvas, (ovnis[i].sprite[ovnis[i].recorrerSprite].height/ovnis[i].escalaovni)*escalado_canvas)
						}
